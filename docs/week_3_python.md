...
| Notebook session 2   | [![Open Notebook in Codespaces](https://img.shields.io/badge/Notebook-blue?logo=github)](Notebook](week_3_python_notebook_2.html){: target="_blank"} |
