...
This is the readme file. It is the "landing page" for new users and should explain the goals and features of the project, include links to the documentation, and explain how to contribute.
The README.md is displayed on the GitHub page of the project:
